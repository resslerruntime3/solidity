 ...
 * Commandline Interface: Add `--no-append-metadata` that skips metadata from getting appended at the end of the deployed bytecode.
 * Standard JSON: Add a boolean field `settings.metadata.append` that skips metadata from getting appended at the end of the deployed bytecode.
